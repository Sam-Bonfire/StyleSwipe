...
export class VectorizationService {
    ...
    public static async getInstance(progressCallback?: (progress: TransformerProgress) => void): Promise<VectorizationService> {
    ...
    public async generateEmbedding(text: string): Promise<number[]> {
        ...
        const extractor = this.extractor as (text: string, options: { pooling: 'mean'; normalize: boolean }) => Promise<{ data: number[] }>;
