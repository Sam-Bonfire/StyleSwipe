...
const mockOrderRepo = {
    save: async (order: Order) => { console.log("Saved order", order); },
    findById: async () => null
};
...
export const CheckoutScreen = ({ navigation }: any) => {
    ...
    return (
        <ScrollView backgroundColor="$background" contentContainerStyle={{ padding: 20 }}>
            ...
            {step === 'ADDRESS' && (
                <YStack>
                    <Text fontSize="$5" fontWeight="bold" marginBottom="$4">Shipping Address</Text>
            ...
            {step === 'PAYMENT' && (
                <YStack gap="$4">
                    ...
                    <YStack backgroundColor="$surface" padding="$4" borderRadius="$3" borderWidth={1} borderColor="$primary">
