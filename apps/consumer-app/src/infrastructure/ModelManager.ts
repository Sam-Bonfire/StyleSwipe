...
const DEFAULT_MODEL_URL = 'https://huggingface.co/Xenova/bge-small-en-v1.5/resolve/main/onnx/model_quantized.onnx';
const DEFAULT_TOKENIZER_URL = 'https://huggingface.co/Xenova/bge-small-en-v1.5/resolve/main/tokenizer.json';
const DEFAULT_TOKENIZER_CONFIG_URL = 'https://huggingface.co/Xenova/bge-small-en-v1.5/resolve/main/tokenizer_config.json';
...
const TOKENIZER_CONFIG_URL = process.env.EXPO_PUBLIC_SLM_TOKENIZER_CONFIG_URL || DEFAULT_TOKENIZER_CONFIG_URL;
...
export class ModelManager {
    ...
    static async downloadFile(url: string, dest: string, onProgress?: (progress: number) => void): Promise<string> {
