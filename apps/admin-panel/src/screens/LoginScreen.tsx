    ...
    return (
        <YStack flex={1} justifyContent="center" alignItems="center" backgroundColor="$background">
            ...
            <YStack marginBottom="$6" alignItems="center" space="$3">
                ...
                <H3 color="$color" fontSize="$8">StyleSwipe Admin</H3>
            </YStack>
            ...
            >
                <YStack space="$4">
                    <Text textAlign="center" color="$color">Sign in to the Neural Command Center</Text>
                    ...
                    <YStack space="$3">
                        ...
                        {error ? <Text color="red" fontSize="$3" textAlign="center">{error}</Text> : null}
            ...
            <Text marginTop="$6" color="$color" fontSize="$2">Secure Connection • 256-bit Encryption</Text>
        </YStack>
    );
}
