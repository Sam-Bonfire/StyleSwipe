...
export class TaggingService {
    ...
    private static readonly COLORS = ['red', 'blue', 'green', 'black', 'white', 'grey', 'yellow', 'pink', 'purple', 'navy', 'beige', 'brown'];
    private static readonly MATERIALS = ['cotton', 'polyester', 'silk', 'linen', 'wool', 'leather', 'denim', 'suede'];
