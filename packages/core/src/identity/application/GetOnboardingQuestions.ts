...
export const getOnboardingQuestions = (): Effect.Effect<OnboardingQuestion[], never, never> => {
  return Effect.succeed([
    ...
    {
      id: 'vibe',
      question: "What's your Saturday night vibe?",
      options: ['Party', 'Chill', 'Dinner', 'Adventure'],
    },
    {
      id: 'fit',
    ...
    },
    {
      ...
      options: ['Neutral', 'Dark', 'Pastel', 'Vibrant'],
    },
    {
      id: 'lifestyle',
      question: "What's your primary activity?",
      options: ['Work', 'Gym', 'Date Night', 'Casual'],
    },
  ]);
};
